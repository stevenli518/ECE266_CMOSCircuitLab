...
def Oscilloscope_Trigger_Dchan(inst,Dchan):
    inst.write(":TRIGger:MODE EDGE")
    inst.write(":TRIGger:EDGE:SLOPe POSitive")
    inst.write(":TRIGger:EDGE:SOURce DIGital" + str(Dchan))

def Oscilloscope_Trigger_External(inst):
    inst.write(":TRIGger:MODE EDGE")
    inst.write(":TRIGger:EDGE:SLOPe POSitive")
    inst.write(":TRIGger:EDGE:SOURce EXTernal")
...
def read_DVM_current(inst):
    inst.write("DVM:CURRent?")
